...
function ThisWeek() {
    ...
    useEffect(() => {
        const getFood = async () => {
            try {
              const response = await axios.post('http://localhost:4004/menunextweek', {  });
              console.log("nextweek",response.data)
            ...
            <Container className="containercards">
                ...
                <Col xs={10} md={4} lg={6}>
                    <Card className="card">
                        ...
                        <Button className="lemondas" disabled={disableddays.includes(6)}  onClick={()=> handleCancellation(6)}>Lemondás</Button>
                ...
                <Col xs={10} md={4} lg={6}>
                    <Card className="card">
                        ...
                        <Button className="lemondas" disabled={disableddays.includes(8)} onClick={()=> handleCancellation(8)}>Lemondás</Button>
                    </Card>
                </Col>
                <Col xs={10} md={4} lg={6}>
                    <Card className="card">
                        ...
                        <Button className="lemondas" disabled={disableddays.includes(9)}  onClick={()=> handleCancellation(9)}>Lemondás</Button>
                    </Card>
                </Col>
                <Col xs={10} md={4} lg={6}>
                    <Card className="card">
                        ...
                        <Button className="lemondas" disabled={disableddays.includes(10)}  onClick={()=> handleCancellation(10)}>Lemondás</Button>
                    </Card>
                </Col>
                </>
)}           
